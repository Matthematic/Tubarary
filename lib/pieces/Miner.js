...
var Miner = function (_Piece) {
    _inherits(Miner, _Piece);

    function Miner() {
        _classCallCheck(this, Miner);

        return _possibleConstructorReturn(this, (Miner.__proto__ || Object.getPrototypeOf(Miner)).call(this, _Ranks.MINER, 'Miner'));
    }
